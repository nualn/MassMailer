...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_neg_summan_lataaminen_ei_muuta_saldoa(self):
    ...
    def test_syo_edullisesti_on_mahdollinen_kun_saldo_on_250(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_syo_maukkaasti_on_mahdollinen_kun_saldo_on_400(self):
